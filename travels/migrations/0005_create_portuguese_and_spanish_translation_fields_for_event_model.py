...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Portuguese title for event
        db.add_column(u'travels_event', 'title_pt', self.gf('django.db.models.fields.CharField')(max_length=160, null=True, blank=True))

        # Portuguese description for event
        db.add_column(u'travels_event', 'description_pt', self.gf('django.db.models.fields.TextField')(null=True, blank=True))

        # Spanish title for event
        db.add_column(u'travels_event', 'title_es', self.gf('django.db.models.fields.CharField')(max_length=160, null=True, blank=True))

        # Spanish description for event
        db.add_column(u'travels_event', 'description_es', self.gf('django.db.models.fields.TextField')(null=True, blank=True))

    def backwards(self, orm):
        db.delete_column(u'travels_event', 'title_pt')
        db.delete_column(u'travels_event', 'description_pt')
        db.delete_column(u'travels_event', 'title_es')
        db.delete_column(u'travels_event', 'description_es')
