...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Cast.post_to_twitter'
        db.add_column(u'travels_cast', 'post_to_twitter', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Cast.post_to_facebook'
        db.add_column(u'travels_cast', 'post_to_facebook', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Cast.post_to_twitter'
        db.delete_column(u'travels_cast', 'post_to_twitter')

        # Deleting field 'Cast.post_to_facebook'
        db.delete_column(u'travels_cast', 'post_to_facebook')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 27, 20, 49, 7, 658658)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 27, 20, 49, 7, 658150)'}),
