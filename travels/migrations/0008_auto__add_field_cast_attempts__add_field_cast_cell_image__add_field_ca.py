...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Cast.attempts'
        db.add_column(u'travels_cast', 'attempts', self.gf('django.db.models.fields.IntegerField')(default=0, null=True), keep_default=False)

        # Adding field 'Cast.cell_image'
        db.add_column(u'travels_cast', 'cell_image', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Cast.cell_timestamp'
        db.add_column(u'travels_cast', 'cell_timestamp', self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True), keep_default=False)

        # Adding field 'Cast.guid'
        db.add_column(u'travels_cast', 'guid', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True), keep_default=False)

        # Adding field 'Cast.cell_revision'
        db.add_column(u'travels_cast', 'cell_revision', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Cast.attempts'
        db.delete_column(u'travels_cast', 'attempts')

        # Deleting field 'Cast.cell_image'
        db.delete_column(u'travels_cast', 'cell_image')

        # Deleting field 'Cast.cell_timestamp'
        db.delete_column(u'travels_cast', 'cell_timestamp')

        # Deleting field 'Cast.guid'
        db.delete_column(u'travels_cast', 'guid')

        # Deleting field 'Cast.cell_revision'
        db.delete_column(u'travels_cast', 'cell_revision')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 18, 22, 41, 6, 767844)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 18, 22, 41, 6, 767306)'}),
