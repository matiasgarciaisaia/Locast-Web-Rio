...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'travels_settings', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('location', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, blank=True)),
            ('project_title', self.gf('django.db.models.fields.CharField')(default="Welcome to UNICEF's Youth Led Digital Mapping", max_length=256, blank=True)),
            ('project_descrition', self.gf('django.db.models.fields.TextField')(default='This project explores tools to help youth build impactful, communicative digital maps using mobile and web technologies. A phone application allows youth to produce a realtime portrait of their community through geo-located photos and videos, organized in thematic maps.', blank=True)),
            ('window_title', self.gf('django.db.models.fields.CharField')(default="UNICEF's Youth Led Digital Mapping", max_length=256, blank=True)),
        ))
        db.send_create_signal(u'travels', ['Settings'])


    def backwards(self, orm):
        
        # Deleting model 'Settings'
        db.delete_table(u'travels_settings')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 22, 21, 51, 27, 338236)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 22, 21, 51, 27, 337321)'}),
        ...
        u'travels.settings': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {'null': 'True', 'blank': 'True'}),
            'project_descrition': ('django.db.models.fields.TextField', [], {'default': "'This project explores tools to help youth build impactful, communicative digital maps using mobile and web technologies. A phone application allows youth to produce a realtime portrait of their community through geo-located photos and videos, organized in thematic maps.'", 'blank': 'True'}),
