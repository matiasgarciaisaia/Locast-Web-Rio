...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column(u'travels_settings', 'project_description_pt', self.gf('django.db.models.fields.TextField')(null=True, blank=True))

        db.add_column(u'travels_settings', 'project_description_en', self.gf('django.db.models.fields.TextField')(null=True, blank=True))

        db.add_column(u'travels_settings', 'project_description_fr', self.gf('django.db.models.fields.TextField')(null=True, blank=True))

        db.add_column(u'travels_settings', 'project_description_es', self.gf('django.db.models.fields.TextField')(null=True, blank=True))

        db.add_column(u'travels_settings', 'project_title_pt', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True))

        db.add_column(u'travels_settings', 'project_title_en', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True))

        db.add_column(u'travels_settings', 'project_title_fr', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True))

        db.add_column(u'travels_settings', 'project_title_es', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True))

        db.add_column(u'travels_settings', 'window_title_pt', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True))

        db.add_column(u'travels_settings', 'window_title_en', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True))

        db.add_column(u'travels_settings', 'window_title_fr', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True))

        db.add_column(u'travels_settings', 'window_title_es', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True))


    def backwards(self, orm):
        db.delete_column(u'travels_settings', 'project_description_pt')
        db.delete_column(u'travels_settings', 'project_description_en')
        db.delete_column(u'travels_settings', 'project_description_fr')
        db.delete_column(u'travels_settings', 'project_description_es')

        db.delete_column(u'travels_settings', 'project_title_pt')
        db.delete_column(u'travels_settings', 'project_title_en')
        db.delete_column(u'travels_settings', 'project_title_fr')
        db.delete_column(u'travels_settings', 'project_title_es')

        db.delete_column(u'travels_settings', 'window_title_pt')
        db.delete_column(u'travels_settings', 'window_title_en')
        db.delete_column(u'travels_settings', 'window_title_fr')
        db.delete_column(u'travels_settings', 'window_title_es')
    ...
    models = {
        ...
        u'travels.settings': {
            ...
            'project_description_es': ('django.db.models.fields.TextField', [], {'default': "'Este proyecto explora herramientas para ayudar a los jóvenes a construir mapas que generen un impacto en la comunidad, a través de tecnologías móviles y web. Una aplicación de celular les permite a los jóvenes compartir el estado de su comunidad a través de fotos y videos geolocalizados y organizados en mapas temáticos.'", 'blank': 'True'}),
            ...
            'project_title_es': ('django.db.models.fields.CharField', [], {'default': '"Bienvenidos al proyecto de Mapeo Digital Liderado por Jóvenes de UNICEF"', 'max_length': '256', 'blank': 'True'}),
            'project_title_en': ('django.db.models.fields.CharField', [], {'default': '"Welcome to UNICEF\'s Youth Led Digital Mapping"', 'max_length': '256', 'blank': 'True'}),
            'project_title_fr': ('django.db.models.fields.CharField', [], {'default': '"Welcome to UNICEF\'s Youth Led Digital Mapping"', 'max_length': '256', 'blank': 'True'}),
            'project_title_pt': ('django.db.models.fields.CharField', [], {'default': '"Welcome to UNICEF\'s Youth Led Digital Mapping"', 'max_length': '256', 'blank': 'True'}),
            'window_title': ('django.db.models.fields.CharField', [], {'default': '"UNICEF\'s Youth Led Digital Mapping"', 'max_length': '256', 'blank': 'True'}),
            'window_title_es': ('django.db.models.fields.CharField', [], {'default': '"Mapeo Digital Liderado por Jóvenes de UNICEF"', 'max_length': '256', 'blank': 'True'}),
            'window_title_en': ('django.db.models.fields.CharField', [], {'default': '"UNICEF\'s Youth Led Digital Mapping"', 'max_length': '256', 'blank': 'True'}),
            'window_title_fr': ('django.db.models.fields.CharField', [], {'default': '"UNICEF\'s Youth Led Digital Mapping"', 'max_length': '256', 'blank': 'True'}),
            'window_title_pt': ('django.db.models.fields.CharField', [], {'default': '"UNICEF\'s Youth Led Digital Mapping"', 'max_length': '256', 'blank': 'True'})
        },
        u'travels.tag': {
