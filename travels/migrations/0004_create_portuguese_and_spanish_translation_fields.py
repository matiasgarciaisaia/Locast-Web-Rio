...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Portuguese title for casts
        db.add_column(u'travels_cast', 'title_pt', self.gf('django.db.models.fields.CharField')(max_length=160, null=True, blank=True))

        # Portuguese description for casts
        db.add_column(u'travels_cast', 'description_pt', self.gf('django.db.models.fields.TextField')(null=True, blank=True))

        # Portuguese title for categories
        db.add_column(u'travels_itinerary', 'title_pt', self.gf('django.db.models.fields.CharField')(max_length=160, null=True, blank=True))

        # Portuguese description for categories
        db.add_column(u'travels_itinerary', 'description_pt', self.gf('django.db.models.fields.TextField')(null=True, blank=True))

        # Spanish title for casts
        db.add_column(u'travels_cast', 'title_es', self.gf('django.db.models.fields.CharField')(max_length=160, null=True, blank=True))

        # Spanish description for casts
        db.add_column(u'travels_cast', 'description_es', self.gf('django.db.models.fields.TextField')(null=True, blank=True))

        # Spanish title for categories
        db.add_column(u'travels_itinerary', 'title_es', self.gf('django.db.models.fields.CharField')(max_length=160, null=True, blank=True))

        # Spanish description for categories
        db.add_column(u'travels_itinerary', 'description_es', self.gf('django.db.models.fields.TextField')(null=True, blank=True))


    def backwards(self, orm):
        db.delete_column(u'travels_cast', 'title_pt')
        db.delete_column(u'travels_cast', 'description_pt')
        db.delete_column(u'travels_itinerary', 'title_pt')
        db.delete_column(u'travels_itinerary', 'description_pt')
        db.delete_column(u'travels_cast', 'title_es')
        db.delete_column(u'travels_cast', 'description_es')
        db.delete_column(u'travels_itinerary', 'title_es')
        db.delete_column(u'travels_itinerary', 'title_es')
