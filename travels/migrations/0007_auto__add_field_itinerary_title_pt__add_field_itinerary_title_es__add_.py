...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'Settings.project_description_en'
        db.alter_column(u'travels_settings', 'project_description_en', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Settings.window_title_en'
        db.alter_column(u'travels_settings', 'window_title_en', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Settings.window_title_fr'
        db.alter_column(u'travels_settings', 'window_title_fr', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Settings.window_title_pt'
        db.alter_column(u'travels_settings', 'window_title_pt', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Settings.project_title_pt'
        db.alter_column(u'travels_settings', 'project_title_pt', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Settings.project_title_fr'
        db.alter_column(u'travels_settings', 'project_title_fr', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Settings.project_title_en'
        db.alter_column(u'travels_settings', 'project_title_en', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Settings.project_description_es'
        db.alter_column(u'travels_settings', 'project_description_es', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Settings.project_description_fr'
        db.alter_column(u'travels_settings', 'project_description_fr', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Settings.project_title_es'
        db.alter_column(u'travels_settings', 'project_title_es', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Settings.project_description_pt'
        db.alter_column(u'travels_settings', 'project_description_pt', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Settings.window_title_es'
        db.alter_column(u'travels_settings', 'window_title_es', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Adding field 'Tag.urgency_score'
        db.add_column(u'travels_tag', 'urgency_score', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        # Changing field 'Settings.project_description_en'
        db.alter_column(u'travels_settings', 'project_description_en', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Settings.window_title_en'
        db.alter_column(u'travels_settings', 'window_title_en', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Settings.window_title_fr'
        db.alter_column(u'travels_settings', 'window_title_fr', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Settings.window_title_pt'
        db.alter_column(u'travels_settings', 'window_title_pt', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Settings.project_title_pt'
        db.alter_column(u'travels_settings', 'project_title_pt', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Settings.project_title_fr'
        db.alter_column(u'travels_settings', 'project_title_fr', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Settings.project_title_en'
        db.alter_column(u'travels_settings', 'project_title_en', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Settings.project_description_es'
        db.alter_column(u'travels_settings', 'project_description_es', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Settings.project_description_fr'
        db.alter_column(u'travels_settings', 'project_description_fr', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Settings.project_title_es'
        db.alter_column(u'travels_settings', 'project_title_es', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Settings.project_description_pt'
        db.alter_column(u'travels_settings', 'project_description_pt', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Settings.window_title_es'
        db.alter_column(u'travels_settings', 'window_title_es', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Deleting field 'Tag.urgency_score'
        db.delete_column(u'travels_tag', 'urgency_score')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 7, 14, 57, 35, 198082)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 7, 14, 57, 35, 196170)'}),
