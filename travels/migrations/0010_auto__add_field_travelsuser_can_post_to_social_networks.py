...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TravelsUser.can_post_to_social_networks'
        db.add_column(u'travels_travelsuser', 'can_post_to_social_networks', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TravelsUser.can_post_to_social_networks'
        db.delete_column(u'travels_travelsuser', 'can_post_to_social_networks')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 27, 21, 5, 33, 420882)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 27, 21, 5, 33, 420375)'}),
